...
func OperationPlanCreateProject() operationplan.Plan {
	return operationplan.Plan{OperationID: "delivery.projects.create", Domain: "delivery", Application: "management", UseCase: "create_project", RequestType: "iot.delivery.v1.CreateProjectRequest", ResponseType: "iot.delivery.v1.ProjectResponse", Execution: operationplan.Execution{Transaction: "local", Idempotency: "none"}, Security: operationplan.Security{Public: false, TenantRequired: false, Authentication: []string{"api-key"}, Permissions: []string{"delivery.items.write"}, PermissionMode: "all"}, Composition: operationplan.Composition{Boundary: "local", RequiresOperations: []string{}, PermissionClosure: []string{}}, ApplicationRequires: []string{}, Bindings: operationplan.Bindings{RPC: "/iot.delivery.v1.DeliveryService/CreateProject", HTTP: []operationplan.HTTPBinding{}}}
}

func OperationPlanCreateRelease() operationplan.Plan {
	return operationplan.Plan{OperationID: "delivery.releases.create", Domain: "delivery", Application: "management", UseCase: "create_release", RequestType: "iot.delivery.v1.CreateReleaseRequest", ResponseType: "iot.delivery.v1.ReleaseResponse", Execution: operationplan.Execution{Transaction: "local", Idempotency: "none"}, Security: operationplan.Security{Public: false, TenantRequired: false, Authentication: []string{"api-key"}, Permissions: []string{"delivery.items.write"}, PermissionMode: "all"}, Composition: operationplan.Composition{Boundary: "local", RequiresOperations: []string{}, PermissionClosure: []string{}}, ApplicationRequires: []string{}, Bindings: operationplan.Bindings{RPC: "/iot.delivery.v1.DeliveryService/CreateRelease", HTTP: []operationplan.HTTPBinding{}}}
}

func OperationPlanCreateSprint() operationplan.Plan {
	return operationplan.Plan{OperationID: "delivery.sprints.create", Domain: "delivery", Application: "management", UseCase: "create_sprint", RequestType: "iot.delivery.v1.CreateSprintRequest", ResponseType: "iot.delivery.v1.SprintResponse", Execution: operationplan.Execution{Transaction: "local", Idempotency: "none"}, Security: operationplan.Security{Public: false, TenantRequired: false, Authentication: []string{"api-key"}, Permissions: []string{"delivery.items.write"}, PermissionMode: "all"}, Composition: operationplan.Composition{Boundary: "local", RequiresOperations: []string{}, PermissionClosure: []string{}}, ApplicationRequires: []string{}, Bindings: operationplan.Bindings{RPC: "/iot.delivery.v1.DeliveryService/CreateSprint", HTTP: []operationplan.HTTPBinding{}}}
}
