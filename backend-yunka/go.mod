...
replace github.com/hvritual/yunka.io/framework => ../third_party/yunka/framework

replace github.com/hvritual/yunka.io/pkg => ../third_party/yunka/pkg

replace github.com/hvritual/yunka.io/gateway => ../third_party/yunka/gateway
